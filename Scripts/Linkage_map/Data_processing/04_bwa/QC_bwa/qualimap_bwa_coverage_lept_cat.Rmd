---
title: "Qualimap_bwa_scaffold_coverage_cat"
author: "KN"
date: "18 may 2021"
...
qualimap_cov_mean <- read.table("cat/reads_scaffold_59.txt")
colnames(qualimap_cov_mean) <- c("individual", "scaffold", "length", "reads", "mean", "sd")
str(qualimap_cov_mean)

#subset red scaffolds
qualimap_red <- qualimap_cov_mean[qualimap_cov_mean$scaffold<=52, ]
# 
...
#adultt
ggplot(qualimap_red[qualimap_red$individual=="P10854_196_S219_L004.sorted",], aes(factor(qualimap_red[qualimap_red$individual=="P10854_196_S219_L004.sorted",]$scaffold), qualimap_red[qualimap_red$individual=="P10854_196_S219_L004.sorted",]$mean)) +
   geom_bar(stat="identity",fill="green") +
   theme(panel.background = element_blank()) +
  labs(title = "Adult cat female (196)") +
  xlab("HiC-scaffold") +
  ylab("mean coverage")
...
write.table(unique(lept_males$individual), file = "list_lept_males_cat")
write.table(unique(lept_females$individual), file = "list_lept_females_cat")
...
qualimap_cov_mean <- read.table("cat2/reads_scaffold_59.txt")
colnames(qualimap_cov_mean) <- c("individual", "scaffold", "length", "reads", "mean", "sd")
str(qualimap_cov_mean)
...
write.table(unique(lept_males$individual), file = "list_lept_males_cat2", append = TRUE)
write.table(unique(lept_females$individual), file = "list_lept_females_cat2", append = TRUE)
...
mapped_reads <- read.csv("summary_mapping_cat.csv", header=T, sep = ";")
...
print("Samples with less than 100 000 reads:")
