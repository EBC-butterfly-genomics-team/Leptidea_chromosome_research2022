...
OUTPUT_PATH=$INPUT_PATH/OrderMarker_${LOD_LIM}_${LOD_LIM_JS}_${PREFIX}_2

mkdir $OUTPUT_PATH

#the map from JoinSingles that is most optimal
MAP_FILE=$INPUT_PATH/JoinSingles_map_${LOD_LIM}_${PREFIX}/${PREFIX}_${LOD_LIM}_${LOD_LIM_JS}.js.map_mod_z_filt1_sep
