...
# For the query, the boundaries of the blocks/links are determined based on the orientation of blocks and genes so that the outermost part (start or end) of the outermost genes are used a$
